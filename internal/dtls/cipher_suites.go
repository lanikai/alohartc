...
type protectionProfile struct {
	...
	keyLen         int
	saltLen        int
	auth           func(version uint16, macKey []byte) macFunction
	authKeyLen     int
	authTagLen     int
	rtcpAuthTagLen int
}

var protectionProfiles = []*protectionProfile{
	// SRTP protection profiles, in order of preference
	{SRTP_AES128_CM_HMAC_SHA1_80, cipherAES, 16, 14, macSHA1, 20, 10, 0},
	{SRTP_AES128_CM_HMAC_SHA1_32, cipherAES, 16, 14, macSHA1, 20, 4, 0},
}
...
// A list of SRTP cipher suite IDs that are, or have been, implemented  by this
// package.
//
// Taken from https://tools.ietf.org/html/rfc5764
const (
	SRTP_AES128_CM_HMAC_SHA1_80 uint16 = 0x0001
	SRTP_AES128_CM_HMAC_SHA1_32 uint16 = 0x0002
	SRTP_NULL_HMAC_SHA1_80      uint16 = 0x0005
	SRTP_NULL_HMAC_SHA1_32      uint16 = 0x0006
)
