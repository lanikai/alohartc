...
const (
	...
	extensionSRTP                uint16 = 14 // https://tools.ietf.org/html/rfc5764#section-9
...
type Config struct {
	...
	// ProtectionProfiles is a list of supported SRTP protection profiles.
	// If ProtectionProfiles is nil, the use_srtp DTLS extension is omitted.
...
func (c *Config) Clone() *Config {
	...
	return &Config{
		...
		ProtectionProfiles:          c.ProtectionProfiles,
